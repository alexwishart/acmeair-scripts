...
#
# Script to create a ramdisk and host a MongoDB database suitable for running
# the AcmeAir benchmark.
#
# Prereqs:
...
DBNAME="acmeair"
MONGO_ROOT="$HOME/acmeair/mongo3"
MOUNTPOINT="$HOME/acmeair/ramdisk_${DBNAME}"
